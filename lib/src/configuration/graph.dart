...
class Graph {
  ...
  Graph.sLine(this.data, {this.chartPaint, this.indicators})
      : this.graphType = CHART_TYPE.sline;
  Graph.line(this.data, {this.chartPaint, this.indicators})
      : this.graphType = CHART_TYPE.line;
  Graph.bar(this.data, {this.chartPaint, this.indicators})
      : this.graphType = CHART_TYPE.bar;
  Graph.pie(this.data, {this.chartPaint, this.indicators})
